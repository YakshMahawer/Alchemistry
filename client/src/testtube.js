...
const CustomTestTube = ({color}) => {
    return(
        <svg width="500" height="500" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path id="permanent" d="M 218.985 165.204 V 384.283 C 218.985 397.931 232.87 409 250.003 409 C 267.136 409 281.02 397.935 281.02 384.283 V 385.966 H 218.985 Z" fill={color}/>
