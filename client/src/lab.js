...
const Lab = () => {
    ...
    if (animate) {
      let ctx = gsap.context(() => {
        ...
        gsap.fromTo(
          ".test_tube",
          { rotation: -9 },
          { duration: 0.12, rotation: 6, repeat: -1 }
        );
  ...
  const useHandlePlayClick = () => {
    SetTColor("");
    document
      .getElementsByClassName("video-game-button")[0]
      .classList.add("cclick");
    setAnimate(true);
    setTimeout(() => {
      navigate("/result", {
        replace: true,
  ...
  return (
    <div ref={app} style={{ display: "flex" }}>
      ...
      <div className="lab">
        ...
        <div
          className="w h"
          style={{ height: `${3.23 * chemA}px`, bottom: `${642}px` }}
        ></div>
        <div
          className="x n"
          style={{
            height: `${3.23 * chemB}px`,
            bottom: `${642 + 3.23 * chemA}px`,
          }}
        ></div>
        <div
          className="y c"
          style={{
            height: `${3.23 * chemC}px`,
            bottom: `${642 + 3.23 * chemB + 3.23 * chemA}px`,
          }}
        ></div>
        <div
          className="z f"
          style={{
            height: `${3.23 * chemD}px`,
            bottom: `${642 + 3.23 * chemA + 3.23 * chemB + 3.23 * chemC}px`,
          }}
        ></div>
        <div className="note">
          <span className="note_text">NOTE: </span>All aqeuous solutions are of
          1 M
        </div>
        <div className="logo">
          <img src={logo} alt="" />
